...
export interface InitOutput {
    ...
    readonly wasmclientruntime_get_hud_state: (a: number) => number;
    ...
    readonly wasmclientruntime_create_action_payload: (a: number, b: number, c: number, d: number, e: number, f: bigint) => void;
    readonly wasmclientruntime_drain_action_results: (a: number) => number;
