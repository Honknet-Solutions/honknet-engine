...
export const wasmclientruntime_get_hud_state: (a: number) => number;
...
export const wasmclientruntime_create_action_payload: (a: number, b: number, c: number, d: number, e: number, f: bigint) => void;
export const wasmclientruntime_drain_action_results: (a: number) => number;
