...
export class ClientEntity {
  ...
  public get mapId(): string {
    return this.transform.mapId;
  }

  public get gridId(): string | null {
    return this.transform.gridId;
  }
  ...
  public getDynamicComponent(name: string): unknown {
    return this.replicated.getDynamic(name);
  }
